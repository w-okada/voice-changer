...
SSL_KEY_DIR  = os.path.join(tmpdir, "keys") if hasattr(sys, "_MEIPASS") else "keys"
MODEL_DIR = os.path.join(tmpdir, "logs") if hasattr(sys, "_MEIPASS") else "logs"
UPLOAD_DIR = os.path.join(tmpdir, "upload_dir") if hasattr(sys, "_MEIPASS") else "upload_dir"
