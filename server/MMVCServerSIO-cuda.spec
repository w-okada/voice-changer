...
if sys.platform == 'win32':
    binaries = [(site_packages + '/Lib/site-packages/onnxruntime/capi/onnxruntime_providers_shared.dll', 'onnxruntime/capi'), (site_packages + '/Lib/site-packages/onnxruntime/capi/onnxruntime_providers_cuda.dll', 'onnxruntime/capi')]
else:
    binaries = [(site_packages + '/Lib/site-packages/onnxruntime/capi/onnxruntime_providers_shared.so', 'onnxruntime/capi'), (site_packages + '/Lib/site-packages/onnxruntime/capi/onnxruntime_providers_cuda.so', 'onnxruntime/capi')]
