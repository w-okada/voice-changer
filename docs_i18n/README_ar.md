...
* v.2.2.2-beta
  * إصدارات الإصدار: std_win, std_mac, std_lin_aarch64
  * اعتبارًا من v.2.2.2-beta، تختلف النماذج المدعومة حسب الإصدار (انظر أدناه). كما قد تختلف الإصدارات المنشورة حسب النسخة.
  * يدعم Beatrice v2.0.0-rc0.
* v.2.0.78-beta
...
| الإصدار | المنصة         | النماذج المدعومة |     |
| ------- | -------------- | ----------------- | --- |
| std     | win            | Beatrice          |     |
| std     | mac(m1)        | Beatrice          |     |
