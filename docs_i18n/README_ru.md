...
* v.2.2.2-beta
  * Релизные редакции: std_win, std_mac, std_lin_aarch64
  * Начиная с v.2.2.2-beta, поддерживаемые модели различаются по редакциям (см. ниже). Также набор выпускаемых редакций может различаться в зависимости от версии.
  * Поддержка Beatrice v2.0.0-rc0.
* v.2.0.78-beta
...
| редакция | платформа      | Поддерживаемые модели |     |
| -------- | -------------- | --------------------- | --- |
| std      | win            | Beatrice              |     |
| std      | mac(m1)        | Beatrice              |     |
